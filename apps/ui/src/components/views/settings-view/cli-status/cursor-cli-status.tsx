...
import { Wand2, CheckCircle2, AlertCircle, RefreshCw } from 'lucide-react';
    ...
    >
      <div className="p-6 border-b border-border/50 bg-gradient-to-r from-transparent via-purple-500/5 to-transparent">
        ...
        <p className="text-sm text-muted-foreground/80 ml-12">
          Cursor CLI (cursor-agent) enables AI-powered automation with Cursor Auto and Claude Sonnet
          access.
        </p>
      </div>
          ...
          <div className="space-y-3">
            ...
            {status.auth?.authenticated && (
              <div className="flex items-center gap-2 text-xs text-emerald-400/70 ml-1">
                ...
                <span>Authenticated via {status.auth.method}</span>
              </div>
            )}
          </div>
        ) : (
            ...
            <div className="flex items-start gap-3 p-4 rounded-xl bg-amber-500/10 border border-amber-500/20">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-amber-400/70 mt-1">
                  Install Cursor CLI to use the Auto mode for AI-powered feature implementation.
                </p>
              </div>
            </div>
            <div className="space-y-3">
